...
public final class CartListItemBinding implements ViewBinding {
  ...
  private CartListItemBinding(@NonNull LinearLayout rootView, @NonNull TextView itemCntTv,
      @NonNull TextView itemTitle, @NonNull AppCompatButton minusBtn, @NonNull TextView optionItem,
      @NonNull AppCompatButton plusBtn, @NonNull ImageView productImg,
      @NonNull TextView productPriceItem) {
    this.rootView = rootView;
    this.itemCntTv = itemCntTv;
  ...
  public static CartListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.item_cnt_tv;
      TextView itemCntTv = ViewBindings.findChildViewById(rootView, id);
      if (itemCntTv == null) {
        break missingId;
      }
      ...
      return new CartListItemBinding((LinearLayout) rootView, itemCntTv, itemTitle, minusBtn,
